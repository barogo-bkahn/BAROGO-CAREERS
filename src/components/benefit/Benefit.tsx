...
export default function Benefit() {
  ...
  return (
    <section id="benefit" className={styles.section} aria-labelledby="benefit-title">
      <div className={styles.visual}>
        ...
        <h2 id="benefit-title">BENEFITS</h2>
      </div>
        ...
        <div className={styles.carousel}>
          ...
          <div className={styles.track} ref={trackRef} onScroll={syncActiveIndex}>
            {benefits.map((benefit) => (
              <a className={styles.card} href="/culture" key={benefit.title}>
                <h3>{benefit.title}</h3>
